                           ...
                           cv.call, ...) 
{
  ...
  ## From documentation:
  ## For "elnet", "lognet", "fishnet" and "coxnet" models, a nvars x length(lambda) 
  ## matrix of coefficients, stored in sparse column format ("CsparseMatrix"). 
  ## For "multnet" and "mgaussian", a list of nc such matrices, one for each class.
